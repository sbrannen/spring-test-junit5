 ...
 * from JUnit Jupiter and the Spring TestContext Framework.
 *
 * <p>Note that {@link SpringJUnitJupiterConfig @SpringJUnitJupiterConfig} is
 * meta-annotated with JUnit Jupiter's {@link ExtendWith @ExtendWith} <b>and</b>
...
@DisplayName("@SpringJUnitJupiterConfig Tests")
