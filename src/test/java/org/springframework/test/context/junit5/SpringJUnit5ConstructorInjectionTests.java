...
/**
 * Integration tests which demonstrate support for constructor injection
 * for test classes with the Spring TestContext Framework and JUnit 5.
 *
...
class SpringJUnit5ConstructorInjectionTests {
	...
	SpringJUnit5ConstructorInjectionTests(ApplicationContext applicationContext, @Autowired Person dilbert,
			@Autowired Dog dog, @Value("${enigma}") Integer enigma) {
