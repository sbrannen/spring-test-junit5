...
`1.0.0.RC2` tag, the following Maven coordinates will work.
...
dependencies {
	// ...
	testCompile('com.github.sbrannen:spring-test-junit5:1.0.0.RC2')
	// ...
}
```
...
- [JUnit 5][]: JUnit Jupiter `5.0.0-RC2` and JUnit Platform `1.0.0-RC2`
